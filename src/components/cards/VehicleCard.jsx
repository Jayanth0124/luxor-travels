  ...
  return (
    ...
    >
      ...
      <div className="relative aspect-[16/10] overflow-hidden">
        ...
        {/* TOP CATEGORY */}
        <div className="absolute top-5 left-5 flex items-center gap-2 bg-white/70 backdrop-blur-xl border border-white/50 rounded-full px-4 py-2 shadow-[0_10px_30px_rgba(0,0,0,0.08)]">

          <div className="w-2 h-2 rounded-full bg-luxor-gold animate-pulse" />

          <p className="text-[10px] uppercase tracking-[0.28em] text-[#222] font-medium">
            {vehicle.category}
          </p>
        ...
        <div className="absolute bottom-0 left-0 w-full p-7">
          ...
          <div className="max-w-[80%]">
            ...
            <p className="text-white/75 text-sm leading-relaxed">
              Premium road-trip experience designed for luxury outdoor adventures and unforgettable journeys.
            </p>
      ...
      <div className="relative p-7">
        ...
        <div className="grid grid-cols-2 gap-4 mb-8">
          ...
          <div className="bg-white/80 border border-[#ece5db] rounded-2xl p-4 backdrop-blur-lg">

            <div className="flex items-center gap-3 mb-3">

              <div className="w-10 h-10 rounded-xl bg-luxor-gold/10 flex items-center justify-center text-luxor-gold">
              ...
              <div>
                ...
                <h5 className="text-[#1f1f1f] font-medium">
                  4-6 People
                </h5>
              </div>
        ...
        <div className="flex flex-wrap gap-3 mb-8">
          ...
          {vehicle.features.map((feature, idx) => (
            <div
              key={idx}
              className="flex items-center gap-2 bg-white/70 border border-[#ece5db] rounded-full px-4 py-2 text-sm text-[#5d5852]"
            >
